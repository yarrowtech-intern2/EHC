...
export const metadata = {
  title: "EHC - Electronic Healthcare | Connected Healthcare Platform",
  description:
    "EHC connects patients with doctors, ambulances, blood banks, pharmacies, diagnostics and secure digital health records through one integrated SaaS healthcare platform.",
};
